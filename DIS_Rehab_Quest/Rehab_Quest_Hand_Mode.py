"""
╔══════════════════════════════════════════════════════════════════╗
║     REHAB QUEST — Hand Rehabilitation Mode  v1.0                ║
║  2 Sets × 2 Exercises × 120 s each                              ║
║  10 s rest between exercises │ 30 s rest between sets           ║
║  Exercises:  Hand Raise  ➜  Wrist 360°                          ║
╚══════════════════════════════════════════════════════════════════╝
"""
...
EXERCISE_ORDER = ['hand_raise', 'wrist_circle']
...
def draw_summary_screen(frame, total):
    ...
    text_center(frame,"HAND REHAB COMPLETE!",W//2,cy4+42,1.05,(80,255,130),3)
...
#  MAIN LOOP
# ══════════════════════════════════════════════════════════════════
print("[INFO] Rehab Quest — Hand Rehabilitation Mode")
...
while cap.isOpened():
    ...
    else:  # EXERCISE only (no calibration in hand mode)
    ...
    cv2.imshow("Rehab Quest — Hand Mode", frame)
